  ...
  schedule: [
    ...
    },
    {
      ...
      events: [
        ...
        { time: "2:30 PM", title: "🙏 Thank You — by Himant", description: "Appreciation remarks for all participants, volunteers, sponsors, and the SJSU community. Delivered by Himant.", type: "keynote", duration: "10 min" },
        { time: "2:40 PM", title: "🏅 Awards Ceremony — by Prof. Shim", description: "Winners announced and prizes awarded. Grand Prize, Runner-Up, and special category awards presented by Professor Shim.", type: "keynote", duration: "20 min" },
        { time: "3:00 PM", title: "🎯 Closing & Takeaways — by Rick", description: "Closing remarks and key takeaways from the event. What we built, what we learned, and where local agentic AI goes next. Delivered by Rick.", type: "keynote", duration: "10 min" },
