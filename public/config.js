  ...
  challenges: [
    {
      ...
      emoji: "🤖",
      color: "#0096D6",
      description: "Build autonomous AI agents that reason, plan, and act — entirely on local or hybrid infrastructure. Your agent runs on our shared devices using multi-step reasoning and tool-use, with zero dependency on cloud AI APIs. This is the core track: pure local intelligence.",
      requirements: [
        "Agent must run on the event's shared devices (local or hybrid)",
    ...
    },
    {
      ...
      emoji: "⚡",
      color: "#E5A823",
      description: "Build tools that amplify human productivity using AI — smart assistants, workflow automation, knowledge management, or intelligent collaboration. All inference runs locally or on the shared devices, ensuring speed, privacy, and offline capability.",
      requirements: [
        "AI inference must run on the event's shared devices (local or hybrid) — no cloud AI APIs",
    ...
    },
    {
      ...
      emoji: "🌐",
      color: "#0055A2",
      description: "Build AI applications that address real community needs — in healthcare, education, accessibility, or public services. Projects must run locally or on the shared devices, keeping data private and infrastructure independent of third-party cloud APIs.",
      requirements: [
        "Must run fully local or on the event's shared devices",
    ...
    },
    {
      ...
      emoji: "🎨",
      color: "#7B2FBE",
      description: "Explore the creative frontier of generative AI — text, images, audio, and multimodal experiences — with your AI models running on the event's shared devices (local or hybrid). No cloud AI inference. Just raw local compute and creativity.",
      requirements: [
        "Generative model must run locally or on the shared devices",
        ...
        "Document your model selection and why it runs well on the shared devices",
      ],
    ...
    },
    {
      ...
      emoji: "⚖️",
      color: "#00A878",
      description: "Design AI systems that are transparent, fair, and accountable. AI running on our shared devices is inherently more privacy-preserving — use that to your advantage. Build bias detection tools, explainability frameworks, or auditing systems for locally-run models.",
      requirements: [
        "Focus on fairness, transparency, explainability, or data privacy",
        "Local/hybrid architecture is required — data stays on the event's shared devices or hybrid setup",
  ...
  schedule: [
    {
      ...
      events: [
        ...
        { time: "7:05 PM", title: "Shared Device Access", description: "Technical onboarding — connect to the shared devices, verify your access, and run your first local model. Support team on hand to help.", type: "workshop", duration: "30 min" },
    ...
    },
    {
      ...
      events: [
        { time: "All Day", title: "⚡ Hacking Day", description: "The main build day. Teams work on their projects using the shared devices and local infrastructure. Mentors and advisors circulate throughout the day.", type: "hacking", duration: "" },
