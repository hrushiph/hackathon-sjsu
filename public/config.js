...
const CONFIG = {
  ...
  challenges: [
    ...
    },
    {
      ...
      requirements: [
        "AI inference must not depend on cloud AI APIs — run on your device or the shared devices",
    ...
    },
    {
      ...
      emoji: "🎨",
      color: "#7B2FBE",
      description: "Explore the creative frontier of generative AI — text, images, audio, and multimodal experiences — with your AI models running on local hardware or the event's shared devices. No cloud AI inference. Just raw local compute and creativity.",
      requirements: [
